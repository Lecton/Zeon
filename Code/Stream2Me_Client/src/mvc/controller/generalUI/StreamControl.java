...
import mvc.controller.generalUI.videoPlayer.VideoManager;
...
public class StreamControl {
     ...
     * @param msg
     */
    public static void startVideo(StreamPropertyMessage msg) {
...
//                UserControl.INSTANCE.getUser().setStreamingVideo(true);
    ...
    public static void setAudioPlayerIDs(String userID, String streamID) {
        audioView.setStreamIDs(userID, streamID);
    }

    public static void clearAudioPlayerIDs() {
    ...
    public void closeVideoFrame(String streamID, String userID) {
