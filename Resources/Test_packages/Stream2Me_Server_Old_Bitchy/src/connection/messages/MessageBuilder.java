...
public class MessageBuilder {
    ...
    public static Messages.UserConnection.Greeting generateGreeting(server.database.objects.Users person, boolean success) {
    ...
    public static Messages.UserConnection.NewUser generateNewUser(server.database.objects.Users userProfile) {
